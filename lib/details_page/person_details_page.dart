...
class _PersonDetailsPageState extends State<PersonDetailsPage> {
  ...
  Future<void> personDetails() async {
    ...
    var personDetailsResponse = await http.get(
        Uri.parse(ApiLink.itemDetailsUrl(widget.itemId.toString(), 'person')));
    ...
    if (personDetailsResponse.statusCode == 200) {
      ...
      print(
          "Error: ${personDetailsResponse.statusCode}:${personDetailsResponse.reasonPhrase}");
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar:
          const CustomNavigationBar(currentState: "personDetailsPage"),
                    ...
                    SliverList(
                      ...
                      itemDetails[0]['overview'].isNotEmpty
                          ? Padding(
                              ...
                              child: Text(
                                  'Role : ' +
                                      itemDetails[0]['overview'].toString(),
                                  style: Theme.of(context)
                                      .textTheme
                                      .headlineLarge),
                            )
