...
class TvDetailsPage extends StatefulWidget {
  ...
  const TvDetailsPage(this.itemId);
...
class _TvDetailsPageState extends State<TvDetailsPage> {
  ...
  Future<void> tvDetails() async {
    // tv Details
    var tvDetailsResponse = await http
        .get(Uri.parse(ApiLink.itemDetailsUrl(widget.itemId.toString(), 'tv')));
    ...
    if (tvDetailsResponse.statusCode == 200) {
      ...
      print(
          "Error: ${tvDetailsResponse.statusCode}:${tvDetailsResponse.reasonPhrase}");
    }
  }
                  ...
                  slivers: [
                    ...
                    SliverList(
                      ...
                      Padding(
                        padding: EdgeInsets.only(left: 20, top: 10),
                        child: Text(
                            'Seasons : ' + itemDetails[0]['seasons'].toString(),
                            style: Theme.of(context).textTheme.headlineLarge),
                      ),
                      ...
                      Padding(
                        ...
                        child: Text(
                            'Vote Average : ' +
                                itemDetails[0]['vote_average'].toString(),
                            style: Theme.of(context).textTheme.headlineLarge),
                      ),
                      ...
                      Padding(
                        ...
                        child: Text(
                            'Popularity : ' +
                                itemDetails[0]['popularity'].toString(),
                            style: Theme.of(context).textTheme.headlineLarge),
                      ),
                    ]))
                  ]);
